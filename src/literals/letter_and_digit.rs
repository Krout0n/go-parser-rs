...
///
/// ```
/// use go_parser_rs::literals::letter_and_digit::parse_decimal_digit;
...
///
/// ```
/// use go_parser_rs::literals::letter_and_digit::parse_octal_digit;
/// use nom::{Err, error::{Error,ErrorKind}};
...
///
/// ```
/// use go_parser_rs::literals::letter_and_digit::parse_binary_digit;
/// use nom::{Err, error::{Error,ErrorKind}};
...
///
/// ```
/// use go_parser_rs::literals::letter_and_digit::parse_hex_digit;
/// use nom::{Err, error::{Error,ErrorKind}};
